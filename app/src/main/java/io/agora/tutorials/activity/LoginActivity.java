...
public class LoginActivity extends AppCompatActivity {
                ...
                if (response != null) {
                    ...
                    if (loginInfo != null) {
                        if (loginInfo.getStatus().equals("success")) {
                            ...
                            insertUser(loginInfo.getData().getNickname(),
     ...
     * 把用户数据添加进数据库
     */
    private void insertUser(String nickname, String photo, int house_id, String mobile, String password) {
        UserInfo userInfo = new UserInfo(nickname, photo, house_id, mobile, password);
